 ...
 *
 */
public class JobFacetService extends SolrService {
    public JobFacetService(){
        super();
    ...
    public static String FIELDLIST[][] = {{"id","NUMBER"},
                                            {"name","STRING"}};
     public static String CONTENTTYPE = JobService.CONTENTTYPE;
    ...
    public static void main(String[] args) {
    	JobFacetService gs = new JobFacetService();
