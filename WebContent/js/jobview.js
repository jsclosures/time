function buildJobViewPage(mainContext, mainId,currentChild) {
	...
	require([
         ...
         function(){
        	 ...
        	 internalBuildJobViewPage(mainContext, mainId);
...
function internalBuildJobViewPage(mainContext, mainId) {
    ...
    if (context) {
        ...
        function onListClick(){
            ...
            var doLater = function(){
                anyWidgetById("jobedit").setParent(anyWidgetById(mainId).getTarget());
		...
		console.log(target);
                ...
                getCurrentContext().CacheManager.getData({contenttype:"JOB",nocache: true,parentid: target.id,callback: doLater});
    ...
    function buildMainPage(context){
            ...
            function doAddAction() {
                     ...
                     var doLater = function(){
                        var t = anyWidgetById(mainId).getTarget();
                         ...
                         anyWidgetById("jobedit").setParent(t);
            ...
            function doDeleteAction() {
                     var requestData = {contenttype: "JOB",id: anyWidgetById(mainId).getTarget().id};
